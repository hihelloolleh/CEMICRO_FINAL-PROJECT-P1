...
START:
        ...
        JSR     DELAY_STARTUP   ; Wait for PC connection
...
READ_LOOP:
        ...
        ; [PSU CONTROL] Safety Check
        BCLR    PORTA,X $08     ; PA3 -> LOW (Ensure 5V)
        ...
        ; OE(6)=H, P(5)=H, CE(4)=H
        ; END CYCLE: OE and CE HIGH TOGETHER ("SABAY")
        LDAA    PORTA,X
        ORAA    #$50            ; Set Bit 6 ($40) and Bit 4 ($10)
        STAA    PORTA,X         ; Both go High simultaneously
